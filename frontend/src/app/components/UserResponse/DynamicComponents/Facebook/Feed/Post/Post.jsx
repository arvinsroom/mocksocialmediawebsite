...
const Post = () => {
  ...
  // function getSelectedIds () { return posts; }
  // function currentIndex (index) {
  //   return index;
  // }
  // const { ready } = useSelector(state => state.testtest);
  // const getPosts = createSelector(getSelectedIds, (getPosts) => {
  //   console.log('posts: ',getPosts);
  //   return getPosts;
  // })
  
  // const getPosts = createCachedSelector(
  //   getSelectedIds,
  //   currentIndex,
  //   (myArray, index) => {
  //     const post = myArray[index];
  //     return { post };
  //   })
  //   (
  //     (myArray, index) => { post }
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    let data = {};
    const prevPost = posts[modalState.parentPostIndex];
  ...
  //       // <>
  //       // {console.log('again')}
  //       <div key={singlePost._id} className="post">
  //         <div className="postTop">
  //           <Avatar
  //             // src={profilePic}
  //             className="postTopAvatar"
  ...
  //           {modalState.parentPostIndex !== -1 && posts[modalState.parentPostIndex] ?
  //             <p id="simple-modal-description">
  //               {posts[modalState.parentPostIndex].postMessage ?
  //                 <Text index={modalState.parentPostIndex} />
  //               : null}

  //               {posts[modalState.parentPostIndex].type === 'PHOTO' ?
  //                 <Photo index={modalState.parentPostIndex} />
  //               : null}

  //               {posts[modalState.parentPostIndex].type === 'VIDEO' ? 
  //                 <Video index={modalState.parentPostIndex} />
  //               : null}

  //               {posts[modalState.parentPostIndex].type === 'LINK' ?
