...
const DynamicLink = ({ id }) => {
          ...
          (singlePost.linkTitle || singlePost.linkPreview) ? (
            <>
              <DynamicMedia
                ...
                customCSS="twitterThreeSideBorder twitterCorrectMargin"
              />
              <div className="twitterLinkThreeSideBorder twitterLinkCorrectMargin">
                <div className="twitter-og-title">{singlePost.linkTitle}</div>
  ...
  return <>{renderDynamicLink ? renderDynamicLink : null}</>;
};
