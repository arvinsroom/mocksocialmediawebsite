...
const Share = ({ id }) => {
  ...
  const singleAuthor = useSelector((state) =>
    selectSocialMediaAuthor(state, parentSharedPost.authorId),
  );
  const [renderSharePost, setRenderSharePost] = useState(null);
  const userRegisterData = useSelector((state) => state.userRegister.metaData);
  const [modalOpen, setModalOpen] = useState(false);
  const [activeLink, setActiveLink] = useState(
    parentSharedPost.warningLabel === "OVERPOSTNOTE" ? false : true,
  );
        ...
        <div className="post">
          <div className="postTop">
            {parentSharedPost.attachedAuthorPicture ? (
              <DynamicMediaProfile
                attachedMedia={parentSharedPost.attachedAuthorPicture}
                customCSS="fbAuthorProfileImage"
              />
            ) : (
              <Avatar
                src={
                  parentSharedPost.userPost
          ...
          <Text
            ...
            postMessage={parentSharedPost.postMessage}
            link={parentSharedPost.link}
          />
          ...
          {parentSharedPost.type === "LINK" ? (
            <a
              href={activeLink ? parentSharedPost.link : undefined}
              ...
              <div className="link-area">
                <div className="og-image">
                  <DynamicMedia
                    ...
                    attachedMedia={parentSharedPost.attachedMedia[0]}
                    warningLabel={
                      parentSharedPost.warningLabel === "OVERPOSTNOTE"
                    }
                    labelText={parentSharedPost.labelRichText}
                    type={parentSharedPost.type}
                    openModal={openModal}
                ...
                <div className="fbSharedescriptions">
                  <div className="og-title">{parentSharedPost.linkTitle}</div>
              ...
              <div className="footNoteLabelTop">
                ...
                <div>
                  {parentSharedPost?.labelRichText && (
                    <RenderRichTextArea
                      richText={parentSharedPost.labelRichText}
          ...
          {modalOpen && (
            <SeeWhyModal
              link={parentSharedPost?.checkersLink}
  ...
  return <>{renderSharePost ? renderSharePost : null}</>;
};
