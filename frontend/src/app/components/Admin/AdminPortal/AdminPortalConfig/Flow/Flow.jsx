  ...
  return (
    <>
          ...
          <TableHead>
            <TableRow>
              <TableCell
                ...
                align="center"
              >
                <p>{FLOW_PAGE.PAGE_NAME}</p>
              </TableCell>
              <TableCell
                className={`${classes.body}, ${classes.head}`}
                align="center"
              >
                <p>{FLOW_PAGE.PAGE_TYPE}</p>
              </TableCell>
              <TableCell
                className={`${classes.body}, ${classes.head}`}
                align="center"
              >
                <p>{FLOW_PAGE.CURRENT_FLOW_ORDER}</p>
              </TableCell>
              <TableCell
                className={`${classes.body}, ${classes.head}`}
                align="center"
              >
                <p>{FLOW_PAGE.SET_FLOW_ORDER}</p>
              </TableCell>
              <TableCell
                className={`${classes.body}, ${classes.head}`}
                align="center"
      ...
      >
        ...
        <DialogContent>
          <DialogContentText>
            Deleting this Page will also delete all the responses attached to
            this Page.
            <br></br>
            <br></br>
