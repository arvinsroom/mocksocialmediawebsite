    ...
    <div className={classes.root}>
      ...
      >
        ...
        <List>
          <ListItem
            button
            key={ADMIN_TAB_NAMES.CONDITION_SETTINGS}
            onClick={(e) => handleState(e, "CONDITION-SETTINGS")}
          >
            <ListItemIcon>
              <IconSettings />
            </ListItemIcon>
          ...
          <ListItem
            button
            key={ADMIN_TAB_NAMES.SOCIAL_MEDIA}
            onClick={(e) => handleState(e, "SOCIAL-MEDIA")}
          ...
          <ListItem
            button
            key={ADMIN_TAB_NAMES.WARNING_LABELS}
            onClick={(e) => handleState(e, "WARNING-LABELS")}
            disabled={!templateId ? true : false}
          >
            <ListItemIcon>
              <LabelOutlinedIcon />
          ...
          <ListItem
            button
            key={ADMIN_TAB_NAMES.REGISTRATION}
            onClick={(e) => handleState(e, "REGISTRATION")}
            disabled={!templateId ? true : false}
          >
            <ListItemIcon>
              <IconUserPlus />
          ...
          <ListItem
            button
            key={ADMIN_TAB_NAMES.INFORMATION}
            onClick={(e) => handleState(e, "INFORMATION")}
            disabled={!templateId ? true : false}
          >
            <ListItemIcon>
              <IconInfoCircle />
          ...
          <ListItem
            button
            key={ADMIN_TAB_NAMES.MULTIPLE_CHOICE}
            onClick={(e) => handleState(e, "MULTIPLE-CHOICE")}
            disabled={!templateId ? true : false}
          >
            <ListItemIcon>
              <IconCheckbox />
          ...
          <ListItem
            button
            key={ADMIN_TAB_NAMES.OPEN_TEXT}
            onClick={(e) => handleState(e, "OPENTEXT")}
            disabled={!templateId ? true : false}
          >
            <ListItemIcon>
              <IconForms />
          ...
          <ListItem
            button
            key={ADMIN_TAB_NAMES.REDIRECT}
            onClick={(e) => handleState(e, "REDIRECT")}
            disabled={!templateId ? true : false}
          >
            <ListItemIcon>
              <IconExternalLink />
          ...
          <ListItem
            button
            key={ADMIN_TAB_NAMES.STUDY_FLOW}
            onClick={(e) => handleState(e, "STUDY-FLOW")}
            disabled={!templateId ? true : false}
          >
            <ListItemIcon>
              <IconAdjustments />
