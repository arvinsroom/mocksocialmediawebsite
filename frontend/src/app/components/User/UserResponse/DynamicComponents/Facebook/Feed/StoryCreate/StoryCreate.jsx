...
const StoryCreate = () => {
  ...
  const translate = (...words) => {
    ...
    const finalWord1 = word1
      ? word1
      : FB_TRANSLATIONS_DEFAULT[words[0].toUpperCase()];
    const finalWord2 = word2
      ? word2
      : FB_TRANSLATIONS_DEFAULT[words[1].toUpperCase()];
        ...
        <div className="postOptions">
          {
            <div className="postOption" onClick={openModal}>
              ...
              <p style={{ color: "grey", paddingTop: "4px" }}>
                <b>{translate("photo", "video")}</b>
              </p>
            </div>
          }
          <div className="postOption">
            ...
            <p>
              <b>
                {socialMediaTranslations?.tag_friends ||
                  FB_TRANSLATIONS_DEFAULT.TAG_FRIENDS}
              </b>
            </p>
          </div>
          <div className="postOption onlyLargeScreen">
            ...
            <p>
              <b>{translate("feeling", "activity")}</b>
            </p>
          </div>
        </div>
      </div>
