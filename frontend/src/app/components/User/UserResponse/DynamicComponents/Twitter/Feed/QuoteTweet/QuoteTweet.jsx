...
const QuoteTweet = ({ id, preview }) => {
  ...
  const [singlePost, setSinglePost] = useState(
    useSelector((state) => selectSinglePost(state, id)),
  );
        ...
        <div
          className={
            preview
              ...
              : "twitterQuoteTweetBorderBox twitterQuoteTweetBorderBoxPhone"
          }
        >
              ...
              <div className="twitterPostMediaBox">
                ...
                {singlePost.type === "LINK" ? (
                  <a
                    ...
                    className="twitter-link-preview"
  ...
  return <div>{renderSinglePost ? renderSinglePost : null}</div>;
};
