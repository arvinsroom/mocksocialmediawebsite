...
const TweetBox = ({
  ...
  const handleSubmit = async (e) => {
    ...
    if (!file && !postMessage) {
      ...
      dispatch(
        showInfoSnackbar(
          socialMediaTranslations?.please_limit_characters_to_280 ||
            TW_TRANSLATIONS_DEFAULT.PLEASE_LIMIT_CHARACTERS_TO_280,
        ),
      );
    } else {
      ...
      <div className="tweetBoxMain">
        ...
        {count > 0 && (
          <p className="textAreaWordCount">
            {socialMediaTranslations?.total_characters ||
              TW_TRANSLATIONS_DEFAULT.TOTAL_CHARACTERS}
            : {count}
          </p>
        )}
        ...
        {avatar && (
          <div className="twitterMediaContainer">
            ...
            <ClearIcon
              className="twitterOverlayButton"
        ...
        <div className="tweetBoxBottom">
          ...
          <div className="tweetBoxOtherButton">
            ...
            <div className="pushItemLeft">
              <Button className="tweetBoxButton" onClick={handleSubmit}>
                {socialMediaTranslations?.tweet ||
                  TW_TRANSLATIONS_DEFAULT.TWEET}
              </Button>
            </div>
          </div>
        </div>
