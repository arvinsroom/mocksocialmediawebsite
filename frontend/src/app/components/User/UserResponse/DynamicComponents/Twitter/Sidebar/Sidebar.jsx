    ...
    <>
      <div className="twitterSidebar">
        <SidebarOption
          Icon={SidebarHome}
          active={true}
          text={socialMediaTranslations?.home || TW_TRANSLATIONS_DEFAULT.HOME}
        />
        <SidebarOption
          Icon={SidebarExplore}
          text={
            socialMediaTranslations?.explore || TW_TRANSLATIONS_DEFAULT.EXPLORE
          }
        />
        <SidebarOption
          Icon={SidebarNotifications}
          text={
            socialMediaTranslations?.notifications ||
            TW_TRANSLATIONS_DEFAULT.NOTIFICATIONS
          }
        />
        <SidebarOption
          Icon={SidebarMessages}
          text={
            socialMediaTranslations?.messages ||
            TW_TRANSLATIONS_DEFAULT.MESSAGES
          }
        />
        <SidebarOption
          Icon={SidebarBookmarks}
          text={
            socialMediaTranslations?.bookmarks ||
            TW_TRANSLATIONS_DEFAULT.BOOKMARKS
          }
        />
        <SidebarOption
          Icon={SidebarLists}
          text={socialMediaTranslations?.lists || TW_TRANSLATIONS_DEFAULT.LISTS}
        />
        <SidebarOption
          Icon={SidebarProfile}
          text={
            socialMediaTranslations?.profile || TW_TRANSLATIONS_DEFAULT.PROFILE
          }
        />
        <SidebarOption
          Icon={SidebarMore}
          text={socialMediaTranslations?.more || TW_TRANSLATIONS_DEFAULT.MORE}
        />

        <button variant="outlined" className="sidebarTweet" onClick={openModal}>
