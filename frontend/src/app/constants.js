...
export const TEMPLATE = Object.freeze({
  SELECT_OR_CREATE_TEMPLATE:
    "Please make sure a template is created or selected.",
  ...
  TEMPLATE_DELETE_NOTE:
    "If you delete a condition, you will delete every page associated with that condition as well.",
...
export const REGISTER_PAGE = Object.freeze({
  PROVIDE_A_UNIQUE_PAGE_NAME:
    "Provide a unique name for this registration page",
  SELECT_INFORMATION_REQUESTED_OF_PARTICIPANTS:
    "Select what information will be requested of participants:",
  PROFILE_PHOTO: "Profile photo",
  USERNAME: "Username",
  SUCCESSFULLY_CREATED_REGISTRATION_PAGE:
    "Successfully created registration page",
...
export const FLOW_PAGE = Object.freeze({
  ...
  FLOW_CONFIG_NOTE:
    "Order values should range from 1 to the total number of pages. An order value of 0 represents no order.",
  PAGE_NAME: "Page Name",
  PAGE_TYPE: "Page Type",
...
export const MCQ_PAGE = Object.freeze({
  PROVIDE_A_UNIQUE_PAGE_NAME:
    "Provide a unique name for this multiple-choice page",
  TYPE_QUESTION_HERE: "Type question here",
  TYPE_RESPONSE_OPTION_HERE: "Type response option here",
  SUCCESSFULLY_CREATED_MULTIPLE_CHOICE_PAGE:
    "Successfully created multiple-choice page",
  ANSWER_REQUIRED_QUESTIONS_TO_CONTINUE:
...
export const OPENTEXT_PAGE = Object.freeze({
  PROVIDE_A_UNIQUE_PAGE_NAME:
    "Provide a unique name for this open-text question page",
  TYPE_QUESTION_HERE: "Type question here",
  SUCCESSFULLY_CREATED_OPENTEXT_PAGE:
    "Successfully created open-text question page",
  ANSWER_REQUIRED_QUESTIONS_TO_CONTINUE:
    "Please answer all required questions to continue",
  PLEASE_ENTER_A_VALID_RESPONSE: "Please enter a valid response.",
});
...
export const INFO_PAGE = Object.freeze({
  ...
  SUCCESSFULLY_CREATED_INFORMATION_PAGE:
    "Successfully created information page",
  ADD_I_CONSENT_AND_I_DO_NOT_CONSENT_TO_THE_BOTTOM:
    'Add "I consent" and "I do not consent" options at the bottom of the page',
  ADD_FAKE_POSTS_TO_THE_BOTTOM:
    "Select a social media page to use for the misinformation display (optional).",
  SELECT_SOCIAL_MEDIA_PAGE: "SELECT SOCIAL MEDIA PAGE",
});

export const GENERAL_PAGE = Object.freeze({
  PROVIDE_A_UNIQUE_NAME_FOR_SOCIAL_MEDIA:
    "Provide a unique name for this social media page",
  SELECT_PLATFORM: "Select Platform",
  ORDER_OF_PRESENTATION_OF_POSTS: "Order of presentation of posts",
  SUCCESSFULLY_UPLOADED_SOCIAL_MEDIA_SPREADSHEET:
    "Successfully uploaded spreadsheet of social media posts",
  UPLOADING_A_NEW_SPREADSHEET_WILL_OVERWRITE:
    "Uploading a new language spreadsheet will overwrite any existing language spreadsheet.",

  SUCCESSFULLY_UPLOADED_LANGUAGE_SPREADSHEET:
    "Successfully uploaded language spreadsheet",
  SELECT_LANGUAGE_FOR_SOCIAL_MEDIA_UI:
    "Select language for the social media UI",
  SUCCESSFULLY_SAVED_LANGUAGE_AND_OR_MEDIA:
    "Successfully saved language data and/or uploaded media",
...
export const FINISH_PAGE = Object.freeze({
  ...
  TYPE_TEXT_ALONGSIDE_REDIRECTION_LINK:
    "Type text to appear alongside the redirection link here",
...
export const USER_TRANSLATIONS_DEFAULT = Object.freeze({
  ...
  ACCESS_LOGIN_CODES:
    "Please enter the access code and the participant code you got from Part 1 of the “Interacting with News on Social Media” study below, then click “Login.”",
  ACCESS_CODE: "Access Code",
  PARTICIPANT_ID: "Participant ID",
  INDICATE_YOUR_CHOICES: "Please indicate your choice:",
  CLICK_TO_CONTINUE_STUDY:
    "Click here to continue to the next part of this study",
  THANK_YOU: "Thank you!",
  RESPONSE_SUCCESSFULLY_RECORDED_CLOSE_TAB:
    "Your response has been recorded, and you can safely close this page.",
  RESPONSE_SUCCESSFULLY_SAVED_EACH_PAGE:
    "Successfully saved your responses on this page. Please continue to the next page.",
  ...
  PAGE: "Page",
  PROVIDE_CONSENT:
    "Please indicate whether you consent to participate to continue.",
  LOGIN: "Login",
  I_CONSENT: "I consent",
  I_DO_NOT_CONSENT: "I do not consent",
  PLEASE_UPLOAD_FILE_OF_SIZE_LESS_THAN_20MB:
    "Please upload file of size less than 20MB.",
  PLEASE_ENTER_A_VALID_RESPONSE: "Please enter a valid response.",
  UPLOAD: "Upload",
...
export const WINDOW_GLOBAL = Object.freeze({
  RELOAD_ALERT_MESSAGE:
    "If you reload this page, you might loose the data, Are you sure?",
});
...
export const USER_REGISTER = Object.freeze({
  REGISTER_HANDLE_PARSING_ERROR:
    "Handles can start with @ or nothing and must contain only alphanumeric characters and/or underscores, up to a maximum of 15 characters.",
});
...
export const SEE_WHY_MODAL = Object.freeze({
  ...
  SAY_THIS_INFORMATION_HAS_NO_BASIS_IN_FACT:
    "say this information has no basis in fact.",
});
...
export const SHARE_ANYWAY_MODAL = Object.freeze({
  ...
  INDEPENDENT_FACT_CHECKERS: "Independent fact-checkers",
  GO_BACK: "Go Back",
  SAY_THIS_POST_HAS_FALSE_INFORMATION:
    "say this post has false information. To help stop the spread of false news, a notice will be added to your post if you decide to share this.",
});
